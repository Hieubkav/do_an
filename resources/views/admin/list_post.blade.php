...
@section('content')
    <div id="content" class="container mx-auto p-6 min-h-screen">
        <div class="bg-white border border-gray-300 rounded shadow-lg p-6">
            ...
            <!-- Header -->
            <h5 class="block py-3 text-3xl font-bold text-gray-700 mb-4 md:mb-0">Danh sách bài viết</h5>
                                ...
                                <tr
                                    ...
                                    <td class="px-6 py-4">
                                        <img class=" w-24 h-auto"
                                            src="{{ asset('asset/all_pic/') }}/{{ $post->image->link }}" alt="">
                                    </td>
                                    <td class="px-6 py-4">{{ $post->title }}</td>
                                    <td class="px-6 py-4">{{ $post->user->name }}</td>
                                    @php
                                        $new_date = ('App\Helpers\Support')::change_date($post->created_at);
                                    @endphp
