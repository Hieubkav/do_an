...
@section('content')
                                    ...
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                        ...
                                        <td class="px-6 py-4 grid grid-cols-2 sm:grid-cols-1 gap-2">
                                            <button type="button"
                                                ...
                                                data-des="{{ $category->des }}" data-status="{{ $category->status }}">
    ...
    <div id="myModal" class="fixed inset-0 items-center justify-center z-50 hidden">
        ...
        <div class="bg-white p-4 rounded-lg shadow-xl w-full max-w-md relative z-10">
            ...
            <div class="mt-3">
                <h2 class="text-xl font-semibold mb-3">Thêm danh mục</h2>
                ...
                <form action="{{ route('store_category') }}" method="post">
                    ...
                    <div class="mb-4">
                        <label for="des" class="block text-sm font-medium text-gray-700 mb-2">Mô tả danh mục:</label>
                        <textarea name="des" id="des" class="border rounded-md p-2 w-full" rows="3"
    ...
    <div id="editModal" class="fixed inset-0 items-center justify-center z-50 hidden">
        ...
        <div class="bg-white p-4 rounded-lg shadow-xl w-full max-w-md relative z-10">
            ...
            <div class="mt-3">
                <h2 class="text-xl font-semibold mb-3">Sửa danh mục</h2>

                <!-- Form sửa danh mục -->
                <form action="{{ route('update_category', 'ID_HERE') }}" method="post" id="editForm">
                    @csrf
                    <div class="mb-4">
                        <label for="editName" class="block text-sm font-medium text-gray-700 mb-2">Tên danh mục:</label>
                        <input type="text" name="name" id="editName" class="border rounded-md p-2 w-full"
                            value="{{ $category->name }}">
                    </div>

                    <div class="mb-4">
                        <label for="editDes" class="block text-sm font-medium text-gray-700 mb-2">Mô tả danh mục:</label>
                        <textarea name="des" id="editDes" class="border rounded-md p-2 w-full" rows="3">{{ $category->des }}</textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="status" id="editStatus" class="border rounded-md p-2 w-full">
    ...
    <script>
        document.querySelectorAll('.openEditModalBtn').forEach(function(button) {
            button.addEventListener('click', function() {
                ...
                const categoryDes = button.getAttribute('data-des');
                ...
                document.getElementById('editDes').value = categoryDes;
                document.getElementById('editStatus').value = categoryStatus;

                // Cập nhật action của form dựa trên ID của danh mục
