...
<div id="content" class="container mx-auto p-6 min-h-screen">
    <div class="bg-white border border-gray-300 rounded shadow-lg p-6">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center mb-6">
            <h5 class="text-3xl font-bold text-gray-700 mb-4 md:mb-0">Thêm trang</h5>
        </div>

        <!-- Main Content -->
        <form action="{{ url('/admin/page/add/store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <!-- Image Upload -->
            <div class="mb-4">
                <label for="image" class="block text-gray-700 font-medium mb-2">Ảnh trang</label>
